...
function Transform(url, auth, auth_cb) {
    ...
    this.uploader = function (args, _callback, _errorCallback) {
    return json_call_ajax("Transform.uploader",
        [args], 1, _callback, _errorCallback);
};

    this.uploader_async = function (args, _callback, _error_callback) {
        deprecationWarning();
        return json_call_ajax("Transform.uploader", [args], 1, _callback, _error_callback);
    };
