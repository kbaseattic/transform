...
def transform (args) :
    # ACTUAL SCRIPT NEED TO DOWNLOAD DATA FROM WS here


    # then convert the downloaded object and save as output file
...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--in_name', help='Input workspace object name', action='store', dest='inobj_id', default=None, requiredi=True)
