...
def transform(workspace_service_url=None, workspace_name=None,
    ...
    """
    Converts Chromatography TSV file to json string of KBaseEnigmaMetals.ChromatographyMatrix type.
    ...
    logger.info("Starting conversion of Chromatography TSV to KBaseEnigmaMetals.ChromatographyMatrix")
    ...
    mc = "us.kbase.kbaseenigmametals.ChromatographyMatrixUploader"
    ...
    if tool_process.returncode:
        logger.error("Transformation from TSV.Chromatography to KBaseEnigmaMetals.ChromatographyMatrix failed on {0}".format(input_directory))
        sys.exit(1)
